...
<main class="main">
    ...
    <section class="container section d-flex justify-content-center align-items-center" style="min-height: 70vh; background-image: url('../admin/assets/img/IMG_9296.jpg'); background-size: cover; background-position: center;">
